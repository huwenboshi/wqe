...
calls made by SoCal and those made by CRLMM, a widely used state-or-the-art
genotype calling method.
I first trained SoCal using all the samples with HapMap reference calls to
obtain the ellipsoidal decision regions, then I made genotype calls on the
rest of the samples that are not in the reference set.
