...
then I made genotype calls on the rest of the samples not present in the
reference set.
When comparing SoCal with CRLMM, I excluded the training samples, and compared
these two methods only at samples not present in the training samples.
Table~\ref{table:cmp_socal_crlmm} shows the detailed comparison between SoCal
