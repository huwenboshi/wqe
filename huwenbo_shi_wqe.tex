...
presented here.
In the problem formulation $\beta_{i} > 0$ are the weights assigned to the 
criteria of finding separating ellipsoid---separation ratio,
...
In SoCal, the default values for $\beta_1$, $\beta_2$, $\beta_3$ are
