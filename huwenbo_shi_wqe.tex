...
cluster.
Before an outlier is introduced, both SoCal and RLMM can find good decision
regions for each genotype cluster and make accurate genotype calls.
...
affected, making genotype calling much less accurate.
On the other hand, because SoCal not only considers outliers but also
jointly uses data points from other genotype clusters to form the decision
regions, the decision regions, although affected, are still accurate enough to
