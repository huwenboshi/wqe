...
training data.
As a comparison, I implemented the RLMM algorithm, which independently
...
\par
For accurate comparison, I selected a subset of 3,442 SNPs that have more
than 10 reference calls for each of the genotype cluster from the set of
