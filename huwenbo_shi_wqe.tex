...
\subsection{Comparison with RLMM in the presence of outliers in training data}
...
variance of the Gaussian decision region obtained by RLMM for the genotype AA
cluster is significantly affected, making genotype calling much less accurate.
...
\begin{figure}[H]
    ...
    \subfloat[Decision regions formed by RLMM when an outlier
              ...
              AA cluster.
              The variance of the bivariate Gaussian distribution is
